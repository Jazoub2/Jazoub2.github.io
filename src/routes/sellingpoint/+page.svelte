...
<div class="container">
    <div id="mainsell">
        <img src={animals[index].imgUrl} alt="notfound">
            <button id="like">like</button>
            <button id ="varukorg">varukorg</button>
            <button id="imgswap" on:click={()=>index=index+1}>Increase Index</button>
        </div>
        <div class="scrollable">
            <div class="">h</div>
            <!--each loop for a list with the other products-->
